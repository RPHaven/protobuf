...
class Token extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.rphaven.common.v1.Uid member = 4 [json_name = "member"];</code>
     */
    protected $member = null;
    /**
     * Generated from protobuf field <code>.rphaven.gsts.v1.TokenSignature signature = 5 [json_name = "signature"];</code>
     */
     ...
     *     @type \Rphaven\Common\V1\Uid $member
     *     @type \Rphaven\Gsts\V1\TokenSignature $signature
    ...
    /**
     * Generated from protobuf field <code>.rphaven.gsts.v1.TokenSignature signature = 5 [json_name = "signature"];</code>
     * @return \Rphaven\Gsts\V1\TokenSignature|null
     */
    ...
    /**
     * Generated from protobuf field <code>.rphaven.gsts.v1.TokenSignature signature = 5 [json_name = "signature"];</code>
     * @param \Rphaven\Gsts\V1\TokenSignature $var
     * @return $this
     */
    public function setSignature($var)
    {
        GPBUtil::checkMessage($var, \Rphaven\Gsts\V1\TokenSignature::class);
        $this->signature = $var;
